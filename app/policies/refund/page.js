      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-[#0A0A0A] shadow-lg dark:shadow-none dark:border dark:border-white/[0.06] rounded-lg p-8">
        ...
        <div className="space-y-6 text-gray-700 dark:text-gray-300">
          <section>
            ...
            <h3 className="font-semibold text-gray-800 mt-4 mb-2">1.2 After Shipment</h3>
            <p>
              Once an order has been shipped, it cannot be cancelled. However, you may return the 
              product as per our return policy after receiving it.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We accept returns within <strong>7 days</strong> of delivery for most products. 
              Custom-made or personalized jewellery items are not eligible for return unless 
              defective or damaged.
            </p>

            <h3 className="font-semibold text-gray-800 mt-4 mb-2">2.2 Return Conditions</h3>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>All tags, certificates, and accessories must be included</li>
              <li>No signs of wear, damage, or alteration</li>
            </ul>

            <h3 className="font-semibold text-gray-800 mt-4 mb-2">2.3 Non-Returnable Items</h3>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section>
            ...
            <p>
              ...
              If approved, your refund will be processed within <strong>5-7 business days</strong> to 
              your original payment method.
            </p>

            <h3 className="font-semibold text-gray-800 mt-4 mb-2">3.2 Refund Amount</h3>
            <ul className="list-disc pl-6 space-y-1">
              <li>Full refund for defective or damaged products</li>
              <li>Full refund minus shipping charges for other eligible returns</li>
              <li>Return shipping costs are the responsibility of the customer unless the product is defective</li>
            </ul>

            <h3 className="font-semibold text-gray-800 mt-4 mb-2">3.3 Partial Refunds</h3>
