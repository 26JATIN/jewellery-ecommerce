class ShiprocketAPI {
    ...
    async createReversePickup(returnData) {
        const reversePickupData = {
            ...
            // PICKUP DETAILS - Required for reverse pickup (where courier picks up FROM)
            pickup_customer_name: returnData.customer.name || '',
            pickup_last_name: returnData.customer.lastName || '',
            pickup_address: returnData.customer.address || '',
            pickup_address_2: returnData.customer.address2 || '',
            pickup_city: returnData.customer.city || '',
            pickup_state: returnData.customer.state || '',
            pickup_country: returnData.customer.country || 'India',
            pickup_pincode: returnData.customer.pincode || '',
            pickup_email: returnData.customer.email || '',
            pickup_phone: returnData.customer.phone || '',
        ...
        const requiredFields = [
            'billing_customer_name', 'billing_address', 'billing_city', 
            'billing_pincode', 'billing_state', 'billing_phone',
            'pickup_customer_name', 'pickup_address', 'pickup_city',
            'pickup_state', 'pickup_country', 'pickup_phone', 'pickup_pincode',
            'shipping_customer_name', 'shipping_address', 'shipping_city',
            'shipping_pincode', 'shipping_state', 'shipping_phone'
        ];
